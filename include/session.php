...
class Session
{
   ...
   function checkLogin(){
      ...
      if(isset($_SESSION['username']) && isset($_SESSION['userid']) &&
         ...
         $this->mobile_number     = $this->userinfo['phone'];
         $this->res_id     = $this->userinfo['res_id'];
         $this->city_id     = $this->userinfo['city_id'];
         $this->name     = $this->userinfo['name'];
         $this->user_picture     = $this->userinfo['profile_picture'];
    ...
    */
   function register($subuser, $subpass, $subemail, $subname, $resname1, $city_id, $phone, $user_level){
      ...
      /* No errors, add the new account to the */
         ...
         if($database->addNewUser($subuser, md5($subpass), $subemail, $randid, $subname, $resname1, $city_id, $phone, $user_level)){
            if(EMAIL_WELCOME){               
   ...
   /**
    * isRestaurant - Returns true if currently logged in user is
    * an restaurant or an administrator, false otherwise.
    */
   function isRestaurant(){
      return ($this->userlevel == RESTAURANT_LEVEL ||
              $this->userlevel == ADMIN_LEVEL);
   }

   /**
    * isDriver - Returns true if currently logged in user is
    * an driver or an administrator, false otherwise.
    */
    function isDriver(){
      return ($this->userlevel == DRIVER_LEVEL ||
              $this->userlevel == ADMIN_LEVEL);
   }

   /**
    * isCustomer - Returns true if currently logged in user is
    * an customer or an administrator, false otherwise.
    */
    function isCustomer(){
      return ($this->userlevel == CUSTOMER_LEVEL ||
              $this->userlevel == ADMIN_LEVEL);
   }
